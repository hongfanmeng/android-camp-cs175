...
//                        .setAction("Action", null).show();
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void refreshNotes() {
                MainActivity.this.notesAdapter.refresh(loadNotesFromDatabase());
            }
        });
    ...
    private void updateTitle() {
        ...
        int cnt = sharedPref.getInt("activeCount", 0) + 1;
        setTitle("TodoList " + cnt);
        editor.putInt("activeCount", cnt);
